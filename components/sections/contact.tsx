        ...
        <div className="grid lg:grid-cols-2 gap-16 items-start">
          ...
          <div>
            ...
            <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold text-foreground mb-6 text-balance">
              ...
              <span className="text-primary">ideia em realidade</span>
            </h2>
            <p className="text-muted-foreground text-lg leading-relaxed mb-10">
              Entre em contato conosco para discutir seu projeto. Estamos
              prontos para ajudar você a alcançar seus objetivos tecnológicos.
            </p>
            ...
            <div className="space-y-6">
              <a
                ...
                className="flex items-center gap-4 p-4 rounded-xl bg-card/30 border border-border/50 transition-all duration-300 hover:border-primary/30 hover:bg-card/50 group"
              >
                <div className="p-3 rounded-lg bg-primary/10 text-primary transition-all duration-300 group-hover:bg-primary group-hover:text-primary-foreground">
                  <Mail size={20} />
                </div>
                <div>
            ...
            <div className="mt-10 p-4 rounded-xl bg-background/50 border border-border/50 font-mono text-sm hidden md:block">
              ...
              <div className="space-y-1 text-muted-foreground">
                <p>
                  <span className="text-primary">$</span> npm run start-project
                </p>
                <p>
                  <span className="text-cyan-400">→</span> Conectando com
                  Vectoo...
                </p>
                <p>
                  <span className="text-green-400">✓</span> Pronto para
                  inovar!
                </p>
              </div>
            </div>
          ...
          <div className="relative">
            <div
              className={cn(
                "p-8 md:p-10 rounded-3xl bg-card/50 border border-border/50 backdrop-blur-sm transition-all duration-500",
              ...
              {isSubmitted ? (
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <Button
                    ...
                    className="w-full bg-primary text-primary-foreground hover:bg-primary/90 py-6 text-base font-semibold transition-all duration-300 hover:shadow-[0_0_30px_rgba(98,222,99,0.4)]"
                  >
                    {isSubmitting ? (
                      <>
