    ...
    <section className="relative py-24 overflow-hidden">
      ...
      <div className="container mx-auto px-4 md:px-6 relative z-10">
        <div className="max-w-3xl mx-auto text-center">
          {/* Icon */}
          <div className="inline-flex items-center justify-center w-16 h-16 rounded-2xl bg-primary/10 text-primary mb-8 animate-pulse-glow">
            <Rocket size={32} />
          </div>

          {/* Heading */}
          <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold text-foreground mb-6 text-balance">
            Pronto para decolar seu{" "}
            <span className="text-primary">próximo projeto</span>?
          </h2>
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            <Button
              asChild
              size="lg"
              className="bg-primary text-primary-foreground hover:bg-primary/90 px-8 py-6 text-base font-semibold transition-all duration-300 hover:shadow-[0_0_40px_rgba(98,222,99,0.5)] hover:scale-105"
            >
              <Link href="#contato">
                Começar agora
            ...
            <Button
              ...
              variant="outline"
              size="lg"
              className="border-primary/30 hover:border-primary/50 px-8 py-6 text-base font-semibold transition-all duration-300 hover:bg-primary/5 hover:text-white bg-transparent"
            >
          ...
          <div className="mt-12 pt-8 border-t border-border/30">
            <p className="text-sm text-muted-foreground mb-4">
              Confiado por empresas que buscam excelência
            </p>
            <div className="flex items-center justify-center gap-8 opacity-50">
              {[1, 2, 3, 4].map((i) => (
                <div
                  key={i}
                  className="w-20 h-8 rounded bg-muted-foreground/20"
                />
              ))}
            </div>
          </div>
